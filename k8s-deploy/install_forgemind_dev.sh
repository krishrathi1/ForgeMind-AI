...
helm upgrade --install forgemind-dev $SCRIPT_DIR/forgemind \
  --namespace rag \
...
# Wait for ForgeMind pod to be ready
echo ""
echo "Waiting for forgemind-dev pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=forgemind-dev --timeout=300s -n rag
echo "forgemind-dev pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/forgemind-dev 9621:9621"
echo "==========================================="
echo ""
echo "✅ You can visit ForgeMind at: http://localhost:9621"
echo ""
