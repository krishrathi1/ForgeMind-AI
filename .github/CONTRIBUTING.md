...
- **Bug reports** — open an [issue](https://github.com/krishrathi1/ForgeMind-AI/issues) using the Bug Report template
- **Feature requests** — open an [issue](https://github.com/krishrathi1/ForgeMind-AI/issues) using the Feature Request template
...
Set `FORGEMIND_RUN_INTEGRATION=true` as an environment variable as an alternative to `--run-integration`.
...
Please use the [Bug Report issue template](https://github.com/krishrathi1/ForgeMind-AI/issues/new?template=bug_report.yml). Include:

- ForgeMind version and Python version
...
Please use the [Feature Request issue template](https://github.com/krishrathi1/ForgeMind-AI/issues/new?template=feature_request.yml). Describe:
...
For usage questions, check the [Discussions](https://github.com/krishrathi1/ForgeMind-AI/discussions) tab or open a [Question issue](https://github.com/krishrathi1/ForgeMind-AI/issues/new?template=question.yml).
