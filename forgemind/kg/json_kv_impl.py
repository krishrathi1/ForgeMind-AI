...
from forgemind.file_atomic import reap_orphan_tmp_files
...
from forgemind.exceptions import StorageNotInitializedError
...
class JsonKVStorage(BaseKVStorage):
    ...
    async def _migrate_legacy_cache_structure(self, data: dict) -> dict:
        ...
        """
        from forgemind.utils import generate_cache_key
