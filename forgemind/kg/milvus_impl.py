...
class MilvusVectorDBStorage(BaseVectorStorage):
    ...
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "ForgeMind entities vector storage"
            ...
            description = "ForgeMind relationships vector storage"
            ...
            description = "ForgeMind chunks vector storage"
            ...
            description = "ForgeMind generic vector storage"
    ...
    def _validate_collection_and_load(self) -> None:
        try:
            ...
            logger.error(
                f"[{self.workspace}] 4. Consider recreating the collection using: forgemind-rebuild-vdb "
            )
            logger.error(
