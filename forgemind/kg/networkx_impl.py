...
from forgemind.file_atomic import atomic_write, reap_orphan_tmp_files
from forgemind.types import KnowledgeGraph, KnowledgeGraphNode, KnowledgeGraphEdge
from forgemind.utils import logger, validate_workspace
from forgemind.base import BaseGraphStorage
...
class NetworkXStorage(BaseGraphStorage):
    ...
    async def upsert_node(self, node_id: str, node_data: dict[str, str]) -> None:
        ...
        Persistence:
            ...
            a subsequent ``index_done_callback``. In ``forgemind.py`` this
