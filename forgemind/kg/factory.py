...
from forgemind.kg import STORAGES
...
def get_storage_class(storage_name: str) -> Callable[..., Any]:
    ...
    if storage_name == "NanoVectorDBStorage":
        from forgemind.kg.nano_vector_db_impl import NanoVectorDBStorage
    ...
    # against the top-level ``forgemind`` package, so anchor the import there
    # rather than letting it resolve against this module's own package.
    import_path = STORAGES[storage_name]
    module = importlib.import_module(import_path, package="forgemind")
