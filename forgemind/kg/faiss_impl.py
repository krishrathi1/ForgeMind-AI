...
from forgemind.utils import logger, compute_mdhash_id, validate_workspace
from forgemind.base import BaseVectorStorage
...
class FaissVectorDBStorage(BaseVectorStorage):
    """Faiss-backed vector storage for ForgeMind.
