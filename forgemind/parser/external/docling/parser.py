...
from forgemind.constants import DOCLING_RAW_DIR_SUFFIX, PARSER_ENGINE_DOCLING
...
class DoclingParser(ExternalParserBase):
    ...
    force_reparse_env = "FORGEMIND_FORCE_REPARSE_DOCLING"
    ...
    def is_bundle_valid(
        ...
        *,
        ...
        from forgemind.parser.external.docling import is_bundle_valid
    ...
    async def download_into(
        ...
        *,
        ...
        from forgemind.parser.external.docling import DoclingRawClient
    ...
    def build_ir(self, raw_dir: Path, document_name: str) -> "IRDoc":
        from forgemind.parser.external.docling import DoclingIRBuilder
