...
from forgemind.parser.external._common import env_json
from forgemind.parser.external.docling.manifest import select_main_json
...
def _build_ir_table(
    ...
    # filter in forgemind/parser/external/mineru/ir_builder.py). Drop the
