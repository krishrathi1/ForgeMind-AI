...
from forgemind.constants import MINERU_RAW_DIR_SUFFIX, PARSER_ENGINE_MINERU
...
class MinerUParser(ExternalParserBase):
    ...
    force_reparse_env = "FORGEMIND_FORCE_REPARSE_MINERU"
    ...
    async def download_into(
        ...
        *,
        ...
        from forgemind.parser.external.mineru import MinerURawClient
    ...
    def build_ir(self, raw_dir: Path, document_name: str) -> "IRDoc":
        from forgemind.parser.external.mineru import MinerUIRBuilder
