...
``ForgeMindSidecarFormat-zh.md`` related notes):
...
from forgemind.constants import MINERU_RAW_DIR_SUFFIX, PARSED_DIR_SUFFIX
from forgemind.parser.external.mineru.manifest import load_manifest
