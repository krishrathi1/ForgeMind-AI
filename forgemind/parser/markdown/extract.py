...
- :class:`forgemind.parser.markdown.ir_builder.NativeMarkdownIRBuilder` later
...
from forgemind.parser._html_table import starts_with_html_tag
from forgemind.parser._markdown import render_heading_line
