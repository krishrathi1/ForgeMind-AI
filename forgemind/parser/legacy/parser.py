...
from forgemind.constants import FULL_DOCS_FORMAT_RAW, PARSER_ENGINE_LEGACY
...
class LegacyParser(BaseParser):
    ...
    async def parse(self, ctx: ParseContext) -> ParseResult:
        from forgemind.parser.legacy.extractors import (
            LegacyExtractionError,
            extract_text,
        )
        from forgemind.parser.registry import suffix_capabilities
