...
Two contracts coexist intentionally:
  ...
  - **Legacy contract** — :func:`chunking_by_token_size` keeps its
    ...
    so externally-supplied :attr:`forgemind.ForgeMind.chunking_func`
    ...
    :meth:`ForgeMind.ainsert` calls with raw text.
  ...
  - **File-chunker contract** — for documents whose ``process_options``
    ...
    Currently shipped file chunkers:
      ...
      - :func:`chunking_by_semantic_vector` — the ``"V"`` strategy.
        ...
        :class:`~forgemind.utils.EmbeddingFunc`.
...
from forgemind.chunker.paragraph_semantic import chunking_by_paragraph_semantic
from forgemind.chunker.recursive_character import (
    chunking_by_recursive_character,
)
from forgemind.chunker.semantic_vector import chunking_by_semantic_vector
from forgemind.chunker.token_size import (
