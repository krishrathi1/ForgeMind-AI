...
output rows in the ForgeMind file-chunker schema. The splitter walks the
...
Token accounting goes through the ForgeMind :class:`Tokenizer` via the
...
:func:`forgemind.utils.enforce_chunk_token_limit_before_embedding` does the
...
def chunking_by_recursive_character(
    ...
    *,
    ...
    Args:
        tokenizer: ForgeMind tokenizer; used as the length function so
