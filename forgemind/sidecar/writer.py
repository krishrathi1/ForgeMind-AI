...
This module is the *single executable specification* of the ForgeMind sidecar
format (``docs/ForgeMindSidecarFormat-zh.md``). Engine adapters hand it an
...
from forgemind.sidecar.placeholders import (
    render_drawing_tag,
    render_equation_tag,
    render_table_tag,
    render_template,
...
from forgemind.table_markup import header_grid_to_thead_html
from forgemind.utils import logger, strip_control_characters
