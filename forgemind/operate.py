...
from forgemind.prompt import PROMPTS, resolve_entity_extraction_prompt_profile
...
from forgemind.kg.shared_storage import PipelineStatusLogger, get_storage_keyed_lock
import time
...
def _parse_mm_display_name(content: str, fallback: str) -> str:
    ...
    ``ForgeMind._build_mm_chunks_from_sidecars`` — the producer-side
...
async def extract_entities(
    ...
    if prompt_profile is None:
        ...
        # path that ForgeMind.__post_init__ populates, instead of duplicating
