...
def download_tiktoken_cache(cache_dir: str = None, models: list = None):
    ...
    # Common models used by ForgeMind and OpenAI
    if models is None:
        models = [
            "gpt-4o-mini",  # Default model for ForgeMind
            "gpt-4o",  # GPT-4 Omni
            "gpt-4",  # GPT-4
            ...
            "cl100k_base",  # Default encoding for ForgeMind
        ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="forgemind-download-cache",
        description="Download cache files for ForgeMind offline deployment",
...
For more information, visit: https://github.com/krishrathi1/ForgeMind-AI
    ...
    parser.add_argument(
        "--version", action="version", version="%(prog)s (ForgeMind cache downloader)"
    )

    args = parser.parse_args()

    print("=" * 70)
    print("ForgeMind Offline Cache Downloader")
    print("=" * 70)
