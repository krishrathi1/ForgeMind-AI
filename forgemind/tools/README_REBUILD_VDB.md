...
`forgemind-rebuild-vdb` restores consistency between ForgeMind's authoritative
...
ForgeMind performs multi-step writes (graph + vector storage). If a vector
...
[#2917](https://github.com/krishrathi1/ForgeMind-AI/issues/2917): graph edges with no
...
```bash
# Stop the ForgeMind Server first!
...
(`FORGEMIND_GRAPH_STORAGE`, `FORGEMIND_VECTOR_STORAGE`, `FORGEMIND_KV_STORAGE`,
