...
FORGEMIND_* storage env vars; server-backend deployments should prefer the
library call from a small script wired to their own ForgeMind construction):

    python -m forgemind.tools.kg_integrity_repair [--apply] [--verbose]
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Audit (and optionally repair) ForgeMind per-document "
