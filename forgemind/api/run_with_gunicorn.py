#!/usr/bin/env python
"""
Start ForgeMind server with Gunicorn
"""
...
# Capture this before importing ForgeMind modules, because those imports load .env.
...
def _build_global_concurrency_limits(args) -> dict:
    ...
    """
    from forgemind.llm_roles import ROLES
...
def main():
    from forgemind.api.utils_api import display_splash_screen, check_env_file
    from forgemind.api.config import global_args, initialize_config
    ...
    os.environ["FORGEMIND_GUNICORN_MODE"] = "1"
    ...
    if (
        ...
        print("     forgemind-server --workers 1")
        print("=" * 80 + "\n")
        sys.exit(1)
    ...
    print("🚀 Starting ForgeMind with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load(self):
            ...
            from forgemind.api.forgemind_server import get_application
    ...
    if workers_count > 1:
        ...
        os.environ["FORGEMIND_MAIN_PROCESS"] = "1"
