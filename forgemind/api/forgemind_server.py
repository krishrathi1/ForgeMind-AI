...
from forgemind.api.utils_api import (
...
from forgemind.utils import get_env_value
from forgemind import ForgeMind, ROLES, RoleLLMConfig, __version__ as core_version
from forgemind.api import __api_version__
...
from forgemind.api.routers.document_routes import (
    DocumentManager,
...
from forgemind.api.routers.query_routes import create_query_routes
from forgemind.api.routers.graph_routes import create_graph_routes
from forgemind.api.routers.ollama_api import OllamaAPI

from forgemind.utils import logger, set_verbose_debug
...
from forgemind.api.auth import auth_handler
from forgemind.api.login_rate_limit import LoginRateLimiter
...
def _inject_swagger_theme(html: str, theme: str) -> str:
    ...
    # single boolean attribute `data-forgemind-docs-dark` on <html>. CSS below
          ...
          (function () {{
            ...
            function apply(value) {{
              ...
              if (resolveDark(currentTheme)) {{
                root.setAttribute('data-forgemind-docs-dark', '1');
              }} else {{
                root.removeAttribute('data-forgemind-docs-dark');
              }}
            }}
            apply(currentTheme);
            ...
            window.addEventListener('message', function (event) {{
              var data = event.data;
              if (!data || data.type !== 'forgemind:set-docs-theme') return;
              apply(data.theme);
            }});
          }})();
        </script>
        <style>
          html[data-forgemind-docs-dark="1"] {{
            color-scheme: dark;
          }}

          html[data-forgemind-docs-dark="1"] body,
          html[data-forgemind-docs-dark="1"] .swagger-ui,
          html[data-forgemind-docs-dark="1"] .swagger-ui .scheme-container,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model-box,
          html[data-forgemind-docs-dark="1"] .swagger-ui .opblock,
          html[data-forgemind-docs-dark="1"] .swagger-ui .dialog-ux .modal-ux,
          html[data-forgemind-docs-dark="1"] .swagger-ui .auth-container {{
            background: #0f172a;
            color: #e5e7eb;
          }}

          html[data-forgemind-docs-dark="1"] .swagger-ui .info .title,
          html[data-forgemind-docs-dark="1"] .swagger-ui .opblock-tag,
          html[data-forgemind-docs-dark="1"] .swagger-ui .opblock .opblock-summary-description,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model-title,
          html[data-forgemind-docs-dark="1"] .swagger-ui .parameter__name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .parameter__type,
          html[data-forgemind-docs-dark="1"] .swagger-ui .response-col_status,
          html[data-forgemind-docs-dark="1"] .swagger-ui .response-col_description,
          html[data-forgemind-docs-dark="1"] .swagger-ui .auth-container h4,
          html[data-forgemind-docs-dark="1"] .swagger-ui .auth-container label,
          html[data-forgemind-docs-dark="1"] .swagger-ui .auth-container p,
          html[data-forgemind-docs-dark="1"] .swagger-ui .markdown p,
          html[data-forgemind-docs-dark="1"] .swagger-ui .markdown li,
          html[data-forgemind-docs-dark="1"] .swagger-ui .renderedMarkdown p,
          html[data-forgemind-docs-dark="1"] .swagger-ui .renderedMarkdown li,
          html[data-forgemind-docs-dark="1"] .swagger-ui table thead tr th,
          html[data-forgemind-docs-dark="1"] .swagger-ui table tbody tr td,
          html[data-forgemind-docs-dark="1"] .swagger-ui .tab li,
          html[data-forgemind-docs-dark="1"] .swagger-ui .tab li button.tablinks {{
            color: #e5e7eb;
          }}

          html[data-forgemind-docs-dark="1"] .swagger-ui .opblock-description-wrapper p,
          html[data-forgemind-docs-dark="1"] .swagger-ui .opblock-external-docs-wrapper p,
          html[data-forgemind-docs-dark="1"] .swagger-ui .response-col_links {{
            color: #cbd5f5;
          }}

          html[data-forgemind-docs-dark="1"] .swagger-ui input,
          html[data-forgemind-docs-dark="1"] .swagger-ui textarea,
          html[data-forgemind-docs-dark="1"] .swagger-ui select {{
            background: #020617;
            border-color: #334155;
            color: #f8fafc;
          }}

          html[data-forgemind-docs-dark="1"] .swagger-ui .markdown code,
          html[data-forgemind-docs-dark="1"] .swagger-ui .renderedMarkdown code,
          html[data-forgemind-docs-dark="1"] .swagger-ui .highlight-code,
          html[data-forgemind-docs-dark="1"] .swagger-ui .highlight-code pre,
          html[data-forgemind-docs-dark="1"] .swagger-ui .microlight,
          html[data-forgemind-docs-dark="1"] .swagger-ui .body-param__example,
          html[data-forgemind-docs-dark="1"] .swagger-ui .example,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model-example pre {{
            background: #020617;
            color: #e2e8f0;
          }}
          ...
          html[data-forgemind-docs-dark="1"] .swagger-ui .tab li.active button.tablinks,
          html[data-forgemind-docs-dark="1"] .swagger-ui .tab li.tabitem.active {{
            color: #f8fafc;
            border-bottom-color: #34d399;
          }}

          html[data-forgemind-docs-dark="1"] .swagger-ui .btn.authorize,
          html[data-forgemind-docs-dark="1"] .swagger-ui .auth-wrapper .authorize {{
            background: #064e3b;
            border-color: #34d399;
            color: #d1fae5;
          }}

          html[data-forgemind-docs-dark="1"] .swagger-ui .btn.authorize svg {{
            fill: #d1fae5;
          }}
          ...
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models.is-open,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models h4,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models .model-container,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models .models-control,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model-box {{
            background: #111827;
            border-color: #334155;
          }}
          ...
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models h4,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models h4 button,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models h4 a,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models h4 span,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models .models-control,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models .models-control button,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models .model-toggle,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model .model-title__text,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model .property,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model .prop-name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model .prop-type,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model .prop-format,
          html[data-forgemind-docs-dark="1"] .swagger-ui .expand-operation,
          html[data-forgemind-docs-dark="1"] .swagger-ui .expand-operation span {{
            color: #e5e7eb;
          }}

          html[data-forgemind-docs-dark="1"] .swagger-ui section.models h4 svg,
          html[data-forgemind-docs-dark="1"] .swagger-ui section.models .models-control svg,
          html[data-forgemind-docs-dark="1"] .swagger-ui .model-toggle::after,
          html[data-forgemind-docs-dark="1"] .swagger-ui .expand-operation svg,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion__icon svg,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion__icon svg path {{
            fill: #e5e7eb;
          }}
          ...
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12__title,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-property .json-schema-2020-12__title,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-expand-deep-button,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--primary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--primary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--primary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--primary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--primary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--const .json-schema-2020-12-json-viewer__name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--const .json-schema-2020-12-json-viewer__value,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--default .json-schema-2020-12-json-viewer__name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--default .json-schema-2020-12-json-viewer__value,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--enum .json-schema-2020-12-json-viewer__name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--enum .json-schema-2020-12-json-viewer__value,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--examples .json-schema-2020-12-json-viewer__name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--examples .json-schema-2020-12-json-viewer__value {{
            color: #e5e7eb;
          }}

          /* Secondary / extension / description text — keep them visible but
             dimmer than primary titles. */
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--secondary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--secondary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--extension,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--extension,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--description,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--secondary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--secondary,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--extension,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--extension,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer-extension-keyword .json-schema-2020-12-json-viewer__name,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer-extension-keyword .json-schema-2020-12-json-viewer__value,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--muted {{
            color: #cbd5f5;
          }}
          ...
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--warning,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--warning,
          html[data-forgemind-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--warning {{
            color: #fca5a5;
            border-color: #fca5a5;
          }}
          ...
          /* Per-operation Authorize lock icon. Swagger renders it via
             ...
             states. */
          html[data-forgemind-docs-dark="1"] .swagger-ui .authorization__btn svg,
          html[data-forgemind-docs-dark="1"] .swagger-ui .authorization__btn .locked,
          html[data-forgemind-docs-dark="1"] .swagger-ui .authorization__btn .unlocked {{
            fill: #e5e7eb;
          }}
        </style>
        """
...
# in-app component of `webuiPrefix` injected into window.__FORGEMIND_CONFIG__
# (which the browser sees as `FORGEMIND_API_PREFIX + WEBUI_PATH + "/"`).
# Not user-configurable: a single mount path simplifies the operator surface
# and matches how ForgeMind is deployed in practice. See
...
class _RootPathNormalizationMiddleware:
    ...
    When ``FORGEMIND_API_PREFIX=/site01`` and nginx strips ``/site01`` before
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from forgemind.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from forgemind.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "bedrock":
            from forgemind.llm.binding_options import BedrockLLMOptions
        ...
        if args.llm_binding == "ollama":
            try:
                from forgemind.llm.binding_options import OllamaLLMOptions
        ...
        if args.embedding_binding == "ollama":
            try:
                from forgemind.llm.binding_options import OllamaEmbeddingOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from forgemind.llm.binding_options import GeminiEmbeddingOptions
...
def create_optimized_embedding_function(
    ...
    try:
        if binding == "openai":
            from forgemind.llm.openai import openai_embed

            provider_func = openai_embed
        elif binding == "ollama":
            from forgemind.llm.ollama import ollama_embed

            provider_func = ollama_embed
        elif binding == "gemini":
            from forgemind.llm.gemini import gemini_embed

            provider_func = gemini_embed
        elif binding == "jina":
            from forgemind.llm.jina import jina_embed

            provider_func = jina_embed
        elif binding == "azure_openai":
            from forgemind.llm.azure_openai import azure_openai_embed

            provider_func = azure_openai_embed
        elif binding == "bedrock":
            from forgemind.llm.bedrock import bedrock_embed

            provider_func = bedrock_embed
        elif binding == "lollms":
            from forgemind.llm.lollms import lollms_embed

            provider_func = lollms_embed
        elif binding == "voyageai":
            from forgemind.llm.voyageai import voyageai_embed
...
def create_embedding_function_from_args(
    ...
    """Build the fully configured EmbeddingFunc used by the ForgeMind server.

    Combines the provider embedding factory with the send_dimensions policy
    so that offline tools (e.g. forgemind-rebuild-vdb) can embed in exactly
...
def check_frontend_build():
    ...
    if not index_html.exists():
        ...
        ASCIIColors.cyan("    cd forgemind_webui")
    ...
    try:
        source_dir = Path(__file__).parent.parent.parent / "forgemind_webui"
        ...
        # Key configuration files (in forgemind_webui root directory)
        key_files = [
...
def create_app(args):
    ...
    # Discover third-party parser engines (``forgemind.parsers`` entry points)
    # BEFORE validating routing rules, so FORGEMIND_PARSER may reference them.
    load_third_party_parsers()
    validate_parser_routing_config()
    # Fail fast when DOCX_SMART_HEADING / a FORGEMIND_PARSER rule enables
    ...
    api_key = os.getenv("FORGEMIND_API_KEY") or args.key
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            if "FORGEMIND_GUNICORN_MODE" not in os.environ:
    ...
    base_description = (
        "Providing API for ForgeMind core, Web UI and Ollama Model Emulation"
    )
    swagger_description = (
        base_description
    ...
    # with "Access-Control-Allow-Credentials: true". ForgeMind authenticates via
    ...
    def get_workspace_from_request(request: Request) -> str | None:
        ...
        'FORGEMIND-WORKSPACE' header. If not present, falls back to the
        ...
        workspace = request.headers.get("FORGEMIND-WORKSPACE", "").strip()
    ...
    def create_optimized_openai_llm_func(
        ...
        async def optimized_openai_alike_model_complete(
            ...
            **kwargs,
            ...
            from forgemind.llm.openai import openai_complete_if_cache
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from forgemind.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_gemini_llm_func(
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from forgemind.llm.gemini import gemini_complete_if_cache
    ...
    def create_role_llm_func(role: str, override_meta: dict | None = None):
        ...
        try:
            ...
            if role_binding == "lollms":
                from forgemind.llm.lollms import lollms_model_if_cache
            ...
            if role_binding == "bedrock":
                from forgemind.llm.bedrock import bedrock_complete_if_cache
    ...
    from forgemind.api.config import OllamaServerInfos

    ollama_server_infos = OllamaServerInfos(
        name=args.simulated_model_name, tag=args.simulated_model_tag
    )

    # ForgeMind.__post_init__ normalizes addon_params and backfills env-based defaults
    ...
    try:
        ...
        logger.error(f"Failed to initialize ForgeMind: {e}")
        raise
            ...
            status_data.update(
                {
                    ...
                    if os.environ.get("FORGEMIND_GUNICORN_MODE")
                    else "uvicorn",
    ...
    runtime_config_script = (
        f"<script>window.__FORGEMIND_CONFIG__ = {_runtime_config_payload};</script>"
    )
    ...
    class SmartStaticFiles(StaticFiles):  # Renamed from NoCacheStaticFiles
        ...
        # forgemind_webui/index.html.
        RUNTIME_CONFIG_PLACEHOLDER = b"<!-- __FORGEMIND_RUNTIME_CONFIG__ -->"
...
def configure_logging():
    ...
    for logger_name in ["uvicorn", "uvicorn.access", "uvicorn.error", "forgemind"]:
    ...
    print(f"\nForgeMind log file: {log_file_path}\n")
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "path_filter": {
                    "()": "forgemind.utils.ForgemindPathFilter",
                },
            },
        }
    )
...
def main():
    ...
    # See: https://github.com/krishrathi1/ForgeMind-AI/issues/2438
