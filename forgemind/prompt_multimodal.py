"""Multimodal analysis prompts for ForgeMind.

These templates are consumed by ``ForgeMind.analyze_multimodal`` to produce
...
4. DESCRIPTION (`description`, ≤ 500 words, natural prose — not bullets)
   ...
   - If the table clearly illustrates or supports the surrounding context(leading or trailing text), briefly note that relationship at the end. Otherwise omit.
...
5. DESCRIPTION (`description`, ≤ 300 words, natural prose — not bullets)
   ...
   - If the equation clearly illustrates or supports the surrounding context(leading or trailing text), briefly note that relationship at the end. Otherwise omit.
