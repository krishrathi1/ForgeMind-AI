...
from forgemind.constants import DEFAULT_TEMPERATURE
...
# in ForgeMind. It provides a standardized framework for:
#
...
class BindingOptions:
    ...
    def generate_dot_env_sample(cls):
        """
        Generate a sample .env file for all ForgeMind binding options.
        ...
        sample_top = (
            ...
            + "\n"
            + (
                "# Autogenerated .env entries list for ForgeMind binding options\n"
                "#\n"
                "# To generate run:\n"
                "# $ python -m forgemind.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
        ...
        sample_bottom = (
            ("#\n# End of .env entries for ForgeMind binding options\n")
            + "#" * 80
            + "\n"
        )
...
# inferenceConfig that ForgeMind's bedrock driver actually forwards. See
# ``forgemind/llm/bedrock.py`` for the whitelist — any field added here that is
...
#
# Usage:
#   python -m forgemind.llm.binding_options           # Generate .env sample
#   python -m forgemind.llm.binding_options test      # Test argument parsing
#
# =============================================================================
