...
class OllamaServerInfos:
    def __init__(self, name=None, tag=None):
        self._forgemind_name = name or os.getenv(
            "OLLAMA_EMULATING_MODEL_NAME", DEFAULT_OLLAMA_MODEL_NAME
        )
        self._forgemind_tag = tag or os.getenv(
            "OLLAMA_EMULATING_MODEL_TAG", DEFAULT_OLLAMA_MODEL_TAG
        )
        self.FORGEMIND_SIZE = DEFAULT_OLLAMA_MODEL_SIZE
        self.FORGEMIND_CREATED_AT = DEFAULT_OLLAMA_CREATED_AT
        self.FORGEMIND_DIGEST = DEFAULT_OLLAMA_DIGEST

    @property
    def FORGEMIND_NAME(self):
        return self._forgemind_name

    @FORGEMIND_NAME.setter
    def FORGEMIND_NAME(self, value):
        self._forgemind_name = value

    @property
    def FORGEMIND_TAG(self):
        return self._forgemind_tag

    @FORGEMIND_TAG.setter
    def FORGEMIND_TAG(self, value):
        self._forgemind_tag = value

    @property
    def FORGEMIND_MODEL(self):
        return f"{self._forgemind_name}:{self._forgemind_tag}"
...
class BaseVectorStorage(StorageNameSpace, ABC):
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        Multi-worker note:
            ...
            forgemind-gunicorn) other workers will not observe these writes
...
class BaseKVStorage(StorageNameSpace, ABC):
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        Multi-worker note:
            ...
            deployment (e.g. forgemind-gunicorn) other workers will not
