...
interface ImportMetaEnv {
   ...
   * into `index.html` as `window.__FORGEMIND_CONFIG__`, mirroring what the
   ...
   *
   * See `forgemind_webui/env.development.smaple` and
   ...
   *  `FORGEMIND_API_PREFIX` if a real prefixed backend is being proxied to. */
