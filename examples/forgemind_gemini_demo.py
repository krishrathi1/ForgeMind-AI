"""
ForgeMind Demo with Google Gemini Models

This example demonstrates how to use ForgeMind with Google's Gemini 2.0 Flash model
...
Usage:
    python examples/forgemind_gemini_demo.py
"""
