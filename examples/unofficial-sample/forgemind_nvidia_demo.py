...
from forgemind.utils import locate_json_string_body_from_string
...
async def initialize_rag():
    ...
    # ForgeMind class during indexing
    rag = ForgeMind(
        ...
        embedding_func=EmbeddingFunc(
            ...
            # so truncate (trunc) parameter on embedding_func will handle it and try to examine the tokenizer used in ForgeMind
