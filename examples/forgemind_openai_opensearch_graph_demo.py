"""
ForgeMind Demo with OpenSearch + OpenAI
...
2. Required indices will be auto-created by ForgeMind
...
from forgemind.utils import setup_logger, EmbeddingFunc
...
async def main():
    rag = None
    try:
        print("Initializing ForgeMind with OpenSearch + OpenAI...")
