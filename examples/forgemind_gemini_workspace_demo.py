"""
ForgeMind Data Isolation Demo: Workspace Management

This example demonstrates how to maintain multiple isolated knowledge bases
within a single application using ForgeMind's 'workspace' feature.
...
Usage:
    python forgemind_workspace_demo.py
"""
...
async def initialize_rag(
    ...
    """
    Initializes a ForgeMind instance with data isolation.

    Entity type guidance can be customized by passing
    addon_params={'entity_types_guidance': '...'} to ForgeMind.
    """
...
async def main():
    ...
    try:
        ...
        print("Initializing isolated ForgeMind workspaces...")
