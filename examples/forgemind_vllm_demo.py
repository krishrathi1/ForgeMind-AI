"""
ForgeMind Demo with vLLM (LLM, Embeddings, and Reranker)
...
Usage:
    python examples/forgemind_vllm_demo.py
"""
...
from forgemind.rerank import jina_rerank
