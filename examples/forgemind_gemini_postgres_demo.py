"""
ForgeMind Demo with PostgreSQL + Google Gemini

This example demonstrates how to use ForgeMind with:
...
2. Required tables will be auto-created by ForgeMind
...
Usage:
    python examples/forgemind_postgres_demo.py
"""
...
from forgemind.utils import setup_logger, wrap_embedding_func_with_attrs
...
# --------------------------------------------------
async def initialize_rag() -> ForgeMind:
    rag = ForgeMind(
...
async def main():
    rag = None
    try:
        print("Initializing ForgeMind with PostgreSQL + Gemini...")
        ...
        print("\nInserting document into ForgeMind (this may take some time)...")
