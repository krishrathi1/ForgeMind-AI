"""
ForgeMind Ollama Compatibility Interface Test Script

This script tests the ForgeMind's Ollama compatibility interface, including:
...
def create_error_test_data(error_type: str) -> Dict[str, Any]:
    ...
    """
    error_data = {
        "empty_messages": {"model": "forgemind:latest", "messages": [], "stream": True},
        "invalid_role": {
            "model": "forgemind:latest",
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="ForgeMind Ollama Compatibility Interface Testing",
...
Configuration file (config.json):
  {
    "server": {
      ...
      "model": "forgemind:latest" # Default model name
    },
    "test_cases": {
      "basic": {
