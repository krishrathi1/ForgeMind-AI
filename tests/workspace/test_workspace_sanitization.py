...
to prevent Cypher injection via the FORGEMIND-WORKSPACE HTTP header.
...
from the source files, as the full ForgeMind package has many AI-related dependencies.
...
def get_actual_sanitization_logic():
    ...
    files = [
        os.path.join(base_path, "forgemind/kg/memgraph_impl.py"),
        os.path.join(base_path, "forgemind/kg/neo4j_impl.py"),
    ]
